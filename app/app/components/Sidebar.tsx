...
import { ArrowRight01FreeIcons, CheckIcon, DashboardSquare01FreeIcons, UnfoldMoreIcon, UserPlus } from "@hugeicons/core-free-icons"
...
const Sidebar = () => {
  ...
  const [isWorkspaceAccountModalOpen, setIsWorkspaceAccountModalOpen] = useState(false);
  ...
  return (
      ...
      <div className="w-full relative">
        <div
          onClick={() => setIsWorkspaceAccountModalOpen(!isWorkspaceAccountModalOpen)}
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col -space-y-0.25">
            <h1 className="font-bold text-dark/90 text-[14px]">Ariyo&apos;s Workspace</h1>
        ...
        >
        <HugeiconsIcon icon={UnfoldMoreIcon} className="size-5 text-base cursor-pointer" />
        </button>
      </div>
      <AnimatePresence>
            ...
            >
              <div className="w-full flex items-center justify-between bg-base/10 rounded-[10px] p-1.5">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <h1 className="font-medium text-base text-[15px]">Ariyo&apos;s Workspace</h1>
                </div>
                <HugeiconsIcon className="size-5 text-base" icon={CheckIcon} />
              </div>
      ...
      <div className="flex flex-col gap-0.5 mt-6 w-full">
        <Link href="/" className="flex items-center w-full rounded-xl font-semibold gap-2 p-2 text-[15px] bg-base text-white">
          <HugeiconsIcon icon={DashboardSquare01FreeIcons} className="size-4.75" strokeWidth={1.8} />
          Overview
        </Link>
        <Link href="/" className="flex items-center w-full rounded-xl font-semibold gap-2 p-2 text-[15px] text-base opacity-50">
          <HugeiconsIcon icon={DashboardSquare01FreeIcons} className="size-4.75" strokeWidth={1.8} />
          Overview
        </Link>
        <Link href="/" className="flex items-center w-full rounded-xl font-semibold gap-2 p-2 text-[15px] text-base opacity-50">
        ...
        <div className="flex cursor-pointer items-center justify-between w-full">
          ...
          priority
            ...
            <div className="flex flex-col -space-y-1">
              ...
              <p className="text-[12px] font-semibold text-dark/50">therealteejay25@gmail.com</p>
            </div>
          </div>
          <HugeiconsIcon icon={ArrowRight01FreeIcons} className="size-4.5 text-dark/75" strokeWidth={1.8} />
        </div>
      </div>
    </div>
  )
